    ...
    <fieldset>
        <div class="container-fluid g-0">
            <div class="col-12">
                ...
                <input type="hidden" name="libelle" value="<?= $platcom->libelle; ?>" /><h3><?= $platcom->libelle; ?></h3>
                <h4><?= $platcom->prix; ?>&nbsp; €</h4>
            ...
            <div class="row">
                <div class="col-5">
                    ...
                    <input type="number" class="form-control" name="quantite" value="1" placeholder="Quantité" min="1" max="20" />
                    <div class="form-group">
                        <label for="nom">Nom et Prénom:</label>
                        <input type="text" class="form-control" id="nom_prenom" name="nom_prenom" value="fournier" placeholder="Veuillez saisir votre nom et prénom">
                    </div>
                    <div class="form-group">
                        <label for="email">Email :</label>
                        <input type="text" class="form-control" id="email" name="email" value="dave.loper@afpa.com" placeholder="dave.loper@afpa.com">

                    </div>
                    <div class="form-group">
                        <label for="telephone">Téléphone : </label>
                        <input type="text" class="form-control" id="telephone" name="telephone" value="0322323232" placeholder="Veuillez indiquer votre numéro de télephone">
                    </div>
                    <div class="form-group">
                        <label for="adresse">Adresse :</label>
                        <input type="text" class="form-control" id="adresse" name="adresse" value="12 jfdk" placeholder="Veuillez saisir votre adresse">
                    </div>
                </div>
